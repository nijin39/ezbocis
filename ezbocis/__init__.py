...
def create_app(config_filepath='resource/config.cfg'):
    ...
    from ezbocis.ezbocis_config import PhotologConfig
    ...
    # 데이터베이스 처리 
    from ezbocis.database import DBManager
    ...
    from ezbocis.controller import login
    from ezbocis.controller import app
    from ezbocis.controller import script
    from ezbocis.controller import ezcontrol
