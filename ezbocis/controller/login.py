...
from ezbocis.database import dao
from ezbocis.ezbocis_logger import Log
from ezbocis.ezbocis_blueprint import ezbocis
from ezbocis.model.user import User


@ezbocis.teardown_request
...
@ezbocis.route('/user/login', methods=['POST'])
def login():
